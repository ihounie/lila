...
do
    for model in "mlp" "cnn"
        ...
        python classification_image.py --model $model --method constrained --dataset fmnist _r180 --n_epochs 1000 --device cuda:1 --n_samples_aug 2 --save --batch_size 1000 --seed $seed
        python classification_image.py --model $model --method constrained --dataset fmnist _r90 --n_epochs 1000 --device cuda:1 --n_samples_aug 2 --save --batch_size 1000 --seed $seed
        ...
        python classification_image.py --model $model --method constrained --dataset fmnist  --n_epochs 1000 --device cuda:1 --n_samples_aug 2 --save --batch_size 1000 --seed $seed
        for sz in 312 1250 5000 20000
            ...
            python classification_image.py --model $model --subset_size $sz --method constrained --dataset fmnist _r180 --n_epochs 1000 --device cuda:1 --n_samples_aug 2 --save --batch_size 1000 --seed $seed
            python classification_image.py --model $model --subset_size $sz --method constrained --dataset fmnist _r90 --n_epochs 1000 --device cuda:1 --n_samples_aug 2 --save --batch_size 1000 --seed $seed
